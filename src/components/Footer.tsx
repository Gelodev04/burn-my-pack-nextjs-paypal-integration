...
export const Footer = () => {
  return (
    <footer className="bg-[#333333] text-[8px] md:text-[16px] text-white px-4 py-5 md:pt-10 pb-[1rem] md:pb-[1.5rem]">
      <div className=" md:max-w-[1000px] mx-auto">
        <div className=" border-b pb-[1rem] md:pb-[2.2rem]  border-[#515151] flex ">
          <div className="w-1/2">
            <h6 className="text-[12px] md:text-[20px] font-bold">Contact Us</h6>
            <div className="mt-2 ">
          ...
          <div className="w-1/2">
            <h6 className="text-[12px] md:text-[20px] font-bold">
              Important Notice
            </h6>
            <div className="mt-2">
              <p>
        ...
        <p className="text-center mt-[0.5rem] md:mt-[1rem]  text-[8px] md:text-[16px]">
