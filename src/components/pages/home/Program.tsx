  ...
  return (
    <section className="px-4 pb-[3rem]">
      <div className="flex flex-col items-center max-w-[600px] mx-auto">
        <h1 className="text-[16px] text-center font-semibold text-color1 mt-[2rem]">
          Join the Program
        </h1>
        <div className="mt-[2rem] flex flex-col items-center bg-[#F8F8F8] py-[2.5rem] px-4 w-full rounded-lg">
          <Image
            className="max-w-[80px] h-[90px] "
          ...
          <div className="max-w-[500px] mx-auto">
            <h3 className="text-[22px] text-center font-bold text-color1 mt-[2rem] ">
              Ready to Make the Change?
            </h3>
            <p className="text-[8px] text-[#2D2D2DDD] opacity-[86] text-center mt-2 leading-tight">
            ...
            <div className="mt-10 text-center bg-white py-5 px-4 rounded ">
              <span className="text-[16px] text-[black]">$29.99</span>
