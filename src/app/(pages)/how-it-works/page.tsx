  ...
  return (
   <main>
    ...
    <section className="background px-3 py-10 md:py-[4rem]">
      <div className="rounded-[20px] p-[20px]  bg-white text-black text-[12px] md:text-[18px] flex flex-col items-center max-w-[1087px] mx-auto">
...
Throw away the unfinished pack—about CAD $11. <br /> <br />
...
Make this your final attempt and succeed once and for all. ——&gt; did you use the full text?</p>
